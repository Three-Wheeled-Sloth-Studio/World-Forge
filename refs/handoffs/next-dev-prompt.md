...
Fixed-scale coastal transport, cool-current stability, permanent-ice liquid semantics, bounded continental convergence recycling, corrected biome coverage, and temperature-adjusted forest moisture demand are implemented. Annual hydration tuning is at a stopping point. The ocean structural audit added western-boundary, equatorial-current, and circumpolar metrics and corrected the weak north-equatorial countercurrent in basin circulation v10. Cross-tier western-boundary ratios are 1.406/1.390/1.376, equatorial direction agreement is 0.799/0.769/0.781, and circumpolar continuity is 0.893/0.912/0.912. Next, design explicit seasonal circulation on the fixed grid before revisiting the Horn, monsoon margins, or continental thermal pressure. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance; do not allocate Ultra-scale seasonal arrays.
