...
Fixed-scale wind-aligned coastal transport, cool-current stability, permanent-ice liquid semantics, bounded continental convergence recycling, corrected biome reference coverage, and temperature-adjusted forest moisture demand are implemented. Standard/Ultra wetness rank is 0.602/0.645; biome macro-F1 is 0.529/0.574/0.586. The longitudinal desert audit is complete: the fixed latitude term dominates pressure attribution but is unsafe to widen globally; basin-center and thermal terms are too small, and regional residuals split across coastal fetch, continental/rain-shadow, and equatorial circulation mechanisms. Belt widening, stronger legacy topology-wind rain shadow, and topology-wind fetch scaling were rejected and removed. Next, prototype a cheap final-circulation-aligned precipitation refinement on the fixed 128 x 64 grid, separately measuring upwind-barrier and coastal-fetch effects. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
