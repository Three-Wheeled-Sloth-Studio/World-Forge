...
Fixed-scale wind-aligned coastal transport, wind-oriented exposure, cool-current stability, permanent-ice liquid semantics, and bounded continental convergence recycling are implemented. Standard/Ultra wetness rank is 0.602/0.645 and false-dry rate is 0.559/0.522 while dry-region controls remain stable. The temperate dry-coast residual audit is also complete: direct subsidence drying violates latitude structure, while western-margin geometry is not a useful production fallback at Ultra. No coast correction was accepted. Next, build a biome confusion profile by generated temperature, wetness, ice, relief, and hydrology to determine whether the 0.45-0.48 macro-F1 ceiling is upstream climate error or classifier error. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
