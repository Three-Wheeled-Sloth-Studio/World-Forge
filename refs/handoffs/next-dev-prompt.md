...
Fixed-scale wind-aligned coastal-moisture redistribution is implemented and normalized to conserve its donor contribution. It materially improves inland false-dry behavior, wetness rank, coastality, regional ordering, and Ultra biome F1 with about 4-6% core overhead. The remaining classified defect is observed-dry coasts ranking too wet, especially where offshore or alongshore flow has no inland recipient. Next, audit unconditional coastal wetness against wind/coast orientation and test a bounded generic offshore-flow suppression before considering any climate/circulation stage reorder for cold-current or upwelling physics. Protect transport conservation, inland gains, false-wet rate, latitude error, regional guards, memory, and performance.
