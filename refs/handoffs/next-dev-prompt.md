...
Fixed-scale wind-aligned coastal transport, cool-current stability, permanent-ice liquid semantics, bounded continental convergence recycling, corrected biome reference coverage, and temperature-adjusted forest moisture demand are implemented. Standard/Ultra wetness rank is 0.602/0.645; biome macro-F1 is 0.529/0.574/0.586. The desert-confusion audit shows missed BWh/BWk cells have excessive annual wetness and weaker subsidence; classifier and seasonal-proxy fixes are not supported. Next, diagnose longitudinal pressure-center/aridity placement to determine whether thermal centers, latitude belts, or marine fetch cause low subsidence over missed true-desert cells. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
