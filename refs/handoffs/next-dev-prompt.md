...
Fixed-scale wind-aligned coastal transport, cool-current stability, permanent-ice liquid semantics, bounded continental convergence recycling, corrected biome reference coverage, and temperature-adjusted forest moisture demand are implemented. Standard/Ultra wetness rank is 0.602/0.645; biome macro-F1 is 0.529/0.574/0.586. The longitudinal desert audit is complete. Fixed latitude widening, final-wind coastal/barrier refinements, continental limitation, and a low-cost two-season water-balance proxy all failed to produce durable cross-tier end-to-end gains; all production prototypes were removed. Annual hydration coefficient tuning is at a stopping point. Next, strengthen fixed-grid ocean-circulation validation for western-boundary intensification, equatorial-current direction, subtropical convergence, and open circumpolar flow before changing ocean behavior. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
