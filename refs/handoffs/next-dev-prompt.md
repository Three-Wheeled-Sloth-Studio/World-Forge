...
Fixed-scale wind-aligned coastal transport, wind-oriented exposure, cool-current stability, permanent-ice liquid semantics, and bounded continental convergence recycling are implemented. Standard/Ultra wetness rank is 0.602/0.645 and false-dry rate is 0.559/0.522 while dry-region controls remain stable. Dry-coast and biome-confusion audits are complete. Corrected biome macro-F1 is 0.523/0.552/0.563; forest is overassigned, but a higher static forest threshold does not improve all tiers. Next, derive evaluator-only low-cost seasonality or ecological-structure candidates on the fixed grid and test whether they separate grassland, forest, rainforest, and dry-summer coasts. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
