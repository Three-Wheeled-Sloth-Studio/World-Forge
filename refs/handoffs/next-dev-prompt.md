...
Fixed-scale wind-aligned coastal transport, wind-oriented exposure, cool-current stability, permanent-ice liquid semantics, and bounded continental convergence recycling are implemented. Standard/Ultra wetness rank is 0.602/0.645 and false-dry rate is 0.559/0.522. Dry-coast and biome-confusion audits are complete. Biome macro-F1 is 0.529/0.574/0.586 after correcting unsupported wetland scoring and adding a temperature-adjusted forest threshold; a flat 0.55 threshold and standalone seasonality proxy were rejected. Next, profile reference desert cells generated as forest or grassland using precipitation, moisture, circulation, continentality, and coastal regime to separate upstream wetness excess from missing seasonal aridity. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, memory, and performance.
