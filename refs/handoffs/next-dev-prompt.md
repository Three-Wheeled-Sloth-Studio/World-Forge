...
Fixed-scale wind-aligned coastal transport, wind-oriented exposure, cool-current stability, and permanent-ice liquid semantics are implemented. The interior residual audit found moisture-source starvation rather than transport reach or post-transport loss. Basin circulation v9 now applies bounded convergence recycling only to generated deep continental interiors outside subsiding air. Standard/Ultra wetness rank is 0.602/0.645 and false-dry rate is 0.559/0.522 while dry-region controls remain stable. Next, re-audit the remaining observed-dry temperate coastal errors by generated current exposure, subsidence, wind orientation, relief/rain shadow, precipitation source, and coastline geometry. Protect permanent-ice semantics, inland gains, regional ordering, latitude error, biome F1, memory, and performance.
