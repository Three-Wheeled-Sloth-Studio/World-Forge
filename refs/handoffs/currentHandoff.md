...
Basin circulation v9 retains permanent-ice liquid semantics and adds bounded convergence recycling only over generated deep continental interiors outside subsiding air. Standard/Ultra wetness rank is now 0.602/0.645 and false-dry rate is 0.559/0.522; reference dry-region means remain stable. The dry-coast and biome-confusion audits are complete. Corrected Köppen macro-F1 is 0.523/0.552/0.563 after excluding unsupported wetland from scoring; confusion shows forest overassignment, but a 0.55 forest threshold is not a cross-tier improvement. Next, test evaluator-only low-cost seasonality/ecological signals. Do not feed answer keys into production, retune latitude belts, reapply the ice factor, or solve class errors with a global coefficient.
