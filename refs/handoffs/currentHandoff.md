...
Basin circulation v10 retains permanent-ice liquid semantics and bounded convergence recycling and now carries a materially stronger north-equatorial countercurrent. Standard/Ultra wetness rank is 0.602/0.645 and Köppen macro-F1 is 0.574/0.586. Annual hydration tuning is at a stopping point after controlled coastal, barrier, continental, and two-season counterfactuals failed the end-to-end bar. The ocean audit now protects western-boundary intensification (1.39 Standard), equatorial flow/counterflow (0.769), gyre rotation (0.961), land confinement (1.0), and Southern circumpolar continuity (0.912). Next, design explicit seasonal circulation on the fixed grid before revisiting the Horn, monsoon margins, or continental thermal pressure. Do not feed answer keys into production, add named-region rules, retune annual hydration coefficients, reapply the ice factor, or allocate Ultra-scale seasonal layers.
