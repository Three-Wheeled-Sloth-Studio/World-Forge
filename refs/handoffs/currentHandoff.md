...
Basin circulation v9 retains permanent-ice liquid semantics and bounded convergence recycling. Standard/Ultra wetness rank is 0.602/0.645 and false-dry rate is 0.559/0.522. The dry-coast and biome-confusion audits are complete. Köppen macro-F1 is now 0.529/0.574/0.586: unsupported wetland is excluded from scoring, and a temperature-adjusted forest threshold preserves cool forest while requiring more moisture from warm forest. A global 0.55 threshold and a standalone seasonality proxy were rejected. Next, localize reference desert cells generated as forest/grassland. Do not feed answer keys into production, retune latitude belts, reapply the ice factor, or solve class errors with a global coefficient.
