...
console.log(JSON.stringify({ heldDayA, heldDayB, resumedDay, spinBefore, spinAfterHorizontal, spinAfterVertical, yawBefore, yawAfter, pitchBefore, pitchAfter, frame: await globe.getAttribute('data-frame-reference'), observer: await surface.getAttribute('data-observer-control') }, null, 2));
await browser.close();
