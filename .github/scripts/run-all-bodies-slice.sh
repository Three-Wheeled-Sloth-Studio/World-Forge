#!/usr/bin/env bash
set -euo pipefail
BRANCH='automation/all-system-bodies-20260801'
...
printf '%s  %s\n' \
  '8dcb3e3803dcbfa53c350dc3fc64a61759bd3b6dda4c89afc4968cc03262d7af' '/tmp/apply-all-bodies.b64' > /tmp/all-bodies-input.sha256
